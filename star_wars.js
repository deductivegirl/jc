...
let { name: planet_name, rotation_period: planet_rotation, orbital_period: planet_orbit, diameter: planet_diameter, 
...
let { name: species_name, classification: species_classification, designation: species_designation, average_height: species_height, 
    ...
    language: species_language, people: species_character, films: species_films, url: species_url } = species
